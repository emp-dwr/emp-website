...
\begin{center}
Authors: Andrew Tran, Vivan Klotz, Catarina Pien, and Morgan Battey$^*$ \\
...
\vspace*{5mm}
 ...
 $^*$\footnotesize{Address correspondence to morgan.battey@water.ca.gov}
...
#| 
include_graphics(here::here(file.path('admin/figures-tables/cwq/cwq_station_map_pdf.jpg')))
```
