...
```{r echo=FALSE, fig.show = 'hold', out.height= '20%', out.width = '20%', fig.align='center'}
knitr::include_graphics(file.path('figures/general/emp-pic-1.png'))
knitr::include_graphics(file.path('figures/general/emp-pic-2.png'))
knitr::include_graphics(file.path('figures/general/emp-pic-3.jpg'))
```
