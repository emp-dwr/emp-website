...
load_section('benthic', envir = knitr::knit_global())
```
...
![Map of EMP’s benthic field sites.](/admin/figures-tables/benthic/benthic_station_map.png){#fig-stations fig-align="center" width="90%"}
...
dwq_stations <- readr::read_csv(
  repo_path('admin', 'figures-tables', 'benthic', 'benthic_stations.csv')
)
...
![List of ten most numerous benthic invertebrate species found at EMP sites.](/admin/figures-tables/benthic/species_list.png){#fig-abund fig-align="center" width="70%"}
...
![Density of benthic organisms, by month, collected at station D24.](/admin/figures-tables/benthic/benthic_bar_d24.png){#fig-benthic_d24 fig-align="center"}
...
![Density of benthic organisms, by month, collected at station D16.](/admin/figures-tables/benthic/benthic_bar_d16.png){#fig-benthic_d16 fig-align="center"}

![Density of benthic organisms, by month, collected at station D28A.](/admin/figures-tables/benthic/benthic_bar_d28a.png){#fig-benthic_d28a fig-align="center"}
...
![Density of benthic organisms, by month, collected at station P8.](/admin/figures-tables/benthic/benthic_bar_p8.png){#fig-benthic_p8 fig-align="center"}

![Density of benthic organisms, by month, collected at station C9.](/admin/figures-tables/benthic/benthic_bar_c9.png){#fig-benthic_c9 fig-align="center"}
...
![Density of benthic organisms, by month, collected at station D4.](/admin/figures-tables/benthic/benthic_bar_d4.png){#fig-benthic_d4 fig-align="center"}
...
![Density of benthic organisms, by month, collected at station D6.](/admin/figures-tables/benthic/benthic_bar_d6.png){#fig-benthic_d6 fig-align="center"}

![Density of benthic organisms, by month, collected at station D7.](/admin/figures-tables/benthic/benthic_bar_d7.png){#fig-benthic_d7 fig-align="center"}
...
![Density of benthic organisms, by month, collected at station D41.](/admin/figures-tables/benthic/benthic_bar_d41.png){#fig-benthic_d41 fig-align="center"}

![Density of benthic organisms, by month, collected at station D41A.](/admin/figures-tables/benthic/benthic_bar_d41a.png){#fig-benthic_d41a fig-align="center"}
...
Previous EMP benthic reports can be found [here](https://github.com/emp-dwr/emp-website/tree/main/admin/archive/benthic).