---
title: "Phytoplankton Monitoring Report for Water Year `r lubridate::year(Sys.Date())-1`"
---
...
\begin{center}
Authors: Tiffany Brown and Ted Flynn$^*$ \\
...
include_graphics(here::here(file.path('admin/figures-tables/phyto/phyto_station_map_pdf.jpg')))
```
