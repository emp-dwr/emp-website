...
#| 
knitr::include_graphics(here::here(file.path('sections/zoop/figures/zoop_station_map.png')))
```
...
```{r echo=FALSE}
#| fig-align: 'center'
knitr::include_graphics(here::here(file.path('sections/zoop/figures/zoop_fig2.png')))
```
...
knitr::include_graphics(here::here(file.path('sections/zoop/figures/zoop_fig3.png')))
```
...
knitr::include_graphics(here::here(file.path('sections/zoop/figures/zoop_fig4.png')))
```
...
knitr::include_graphics(here::here(file.path('sections/zoop/figures/zoop_fig5.png')))
```
...
knitr::include_graphics(here::here(file.path('sections/zoop/figures/zoop_fig6.png')))
```
...
knitr::include_graphics(here::here(file.path('sections/zoop/figures/zoop_fig7.png')))
```
...
knitr::include_graphics(here::here(file.path('sections/zoop/figures/zoop_fig8.png')))
```
