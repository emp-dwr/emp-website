...
#| echo: false
#| fig-align: 'center'
#| fig-cap: 'Map of veliger monitoring stations for the Sacramento-San Joaquin Delta region.'

knitr::include_graphics(here::here(file.path('admin/figures-tables/special-studies/veliger_station_map.png')))
```
