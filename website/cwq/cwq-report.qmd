...
load_section('cwq', envir = knitr::knit_global())
```
...
![Map of D-1641 continuous WQ field sites](/admin/figures-tables/cwq/cwq_station_map.png){#fig-stations fig-align="center" width="90%"}

```{r echo=FALSE, warning=FALSE, message=FALSE, results = 'asis'}
#| label: tbl-stations
#| tbl-cap: 'Continuous WQ stations included within each region of the Delta'

cwq_stations <- readr::read_csv(
  repo_path('admin', 'figures-tables', 'cwq', 'cwq_stations.csv')
)

styler$style_kable(cwq_stations)
```

Data were collected for six water quality parameters and stations were divided between programs (@tbl-programs). For CEMP and SMWQP, all water samples were collected 1-meter below the water surface using a float-mounted YSI EXO2 multi-parameter water quality sonde. These parameters are:
...
cwq_programs <- readr::read_csv(
  repo_path('admin', 'figures-tables', 'cwq', 'cwq_station-programs.csv')
)
...
![Water temperature by region in the San Francisco Bay-Delta estuary.](/admin/figures-tables/cwq/cwq_ts_watertemperature.png){#fig-watertemperature fig-align="center"}
...
![Specific conductance by region in the San Francisco Bay-Delta estuary.](/admin/figures-tables/cwq/cwq_ts_spc.png){#fig-spc fig-align="center"}
...
![Dissolved oxygen by region in the San Francisco Bay-Delta estuary.](/admin/figures-tables/cwq/cwq_ts_dissolvedoxygen.png){#fig-dissolvedoxygen fig-align="center"}
...
![Range of daily dissolved oxygen values at the Stockton Ship Channel (P8).](/admin/figures-tables/cwq/cwq_rri_do.png){#fig-rri fig-align="center"}
...
![pH by region in the San Francisco Bay-Delta estuary.](/admin/figures-tables/cwq/cwq_ts_ph.png){#fig-ph fig-align="center"}
...
![Turbidity by region in the San Francisco Bay-Delta estuary.](/admin/figures-tables/cwq/cwq_ts_turbidity.png){#fig-turbidity fig-align="center"}
...
![Chlorophyll a fluorescence by region in the San Francisco Bay-Delta estuary.](/admin/figures-tables/cwq/cwq_ts_fluorescence.png){#fig-fluorescence fig-align="center"}
...
Old EMP continuous water quality reports can be found [here](https://github.com/emp-dwr/emp-website/tree/main/admin/archive/c-wq).