...
```{r echo=FALSE, message=FALSE, results='hide', fig.show='hold', out.width='70%', fig.align='center'}
region_plts('Northern Interior Delta')
```
...
```{r echo=FALSE, message=FALSE, results='hide', fig.show='hold', out.width='70%', fig.align='center'}
region_plts('Southern Interior Delta')
```
...
```{r echo=FALSE, message=FALSE, results='hide', fig.show='hold', out.width='70%', fig.align='center'}
region_plts('Suisun & Grizzy Bays')
```
