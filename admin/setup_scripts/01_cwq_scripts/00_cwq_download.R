...
dl_cwq_data <- function(){
  ...
  id_data$station_name <- substr(id_)
  ...
  id_data_bottom <- readr::read_delim(url('https://dwrmsweb0263.ad.water.ca.gov/TelemetryDirect/api/Results/ResultDetails?program=100'), delim = '|')
  ...
  url <- paste('https://dwrmsweb0263.ad.water.ca.gov/TelemetryDirect/api/Results/ResultData?program=100&resultid=',id,'&6&start=',startdt,'&end=',enddt,'&version=1',delim = '')
