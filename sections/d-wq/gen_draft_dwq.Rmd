...
# Do you want to download new data from EDI?
download_data <- FALSE # TRUE/FALSE

# Do you want to generate new plots?
generate_new_plots <- FALSE # TRUE/FALSE
...
file_sources <- list.files(path = c('admin/setup_scripts/00_global_scripts','admin/setup_scripts/01_dwq_scripts'), pattern = '.R$', full.names=TRUE, recursive = TRUE)
