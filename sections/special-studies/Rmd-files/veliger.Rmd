...
```{r echo=FALSE, out.width='90%', fig.align='center', fig.cap='Map of veliger monitoring stations for the Sacramento-San Joaquin Delta region.'}
knitr::include_graphics(file.path('sections/special-studies/figures/veligermap.png'))
```

## Sampling Protocols {.unlisted}
...
## Contact Info {.unlisted}
For more information about this study, please contact Morgan Battey at Morgan.Battey@water.ca.gov.