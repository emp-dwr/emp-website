...
!This map will eventually be to the right!
```{r echo=FALSE, fig.align='center', fig.cap='Map of the San Francisco Estuary. EMP\'s sites are located within the yellow box.'}
