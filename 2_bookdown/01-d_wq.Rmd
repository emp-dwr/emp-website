...
pagetitle: Discrete Water Quality
---
```{r echo = F}
options(width = 120)
```
# Discrete Water Quality {#d-wq}


#### EMP Discrete Water Quality Report
This report shows trends in discrete water quality analytes for 2019.
...
```{r echo=FALSE, fig.cap='Figure 1. Surface specific conductance in µS/cm at six regions in the San Francisco Bay-Delta estuary during 2018-2019.', fig.align='center'}
...
```{r echo=FALSE, fig.cap='Figure 2: Surface turbidity in NTU at six regions in the San Francisco Bay-Delta estuary during 2018-2019.', fig.align='center'}
...
```{r echo=FALSE, fig.cap='Figure 3: Dissolved ammonia concentrations in mg/L at six regions in the San Francisco Bay-Delta estuary during 2018-2019. Dashed lines represent the range of possible values for months where the raw value was a non-detect.', fig.align='center'}
...
```{r echo=FALSE, fig.cap='Figure 4: Chlorophyll a concentrations in µg/L at six regions in the San Francisco Bay-Delta estuary during 2018-2019. Dashed lines represent the range of possible values for months where the raw value was a non-detect.', fig.align='center'}
...
```{r echo=FALSE, fig.cap='Figure 5: Dissolved nitrate and nitrite concentrations in mg/L at six regions in the San Francisco Bay-Delta estuary during 2018-2019. Dashed lines represent the range of possible values for months where the raw value was a non-detect.', fig.align='center'}
...
```{r echo=FALSE, fig.cap='Figure 6: Total phosphorous concentrations in mg/L at six regions in the San Francisco Bay-Delta estuary during 2018-2019. Dashed lines represent the range of possible values for months where the raw value was a non-detect.', fig.align='center'}
