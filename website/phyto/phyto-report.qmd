...
source(repo_path('admin', 'import_scripts.R'), local = knitr::knit_global())
load_section('phyto', envir = knitr::knit_global())
```
...
![Map of EMP’s phytoplankton field sites.](/admin/figures-tables/phyto/phyto_station_map.png){#fig-stations fig-align="center" width="90%"}

```{r echo=FALSE, warning=FALSE, message=FALSE, results = 'asis'}
#| label: tbl-stations
#| tbl-cap: 'Stations included within each region of the Delta'

dwq_stations <- readr::read_csv(
  repo_path('admin', 'figures-tables', 'phyto', 'phyto_stations.csv')
)
...
![Phytoplankton composition by algal group.](/admin/figures-tables/phyto/phyto_tree.png){#fig-alg fig-align="center" width="100%"}
...
![Chlorophyll a and pheophytin a average concentrations in Carquinez.](/admin/figures-tables/phyto/phyto_wq_carquinez.png){#fig-wq-carquinez fig-align="center"}

#### Phytoplankton

`r strings_phyto_cur$summary_region_txt('Carquinez')` (Other, @fig-phy-carquinez).

![Density of phytoplankton organisms in Carquinez.](/admin/figures-tables/phyto/phyto_bar_carquinez.png){#fig-phy-carquinez fig-align="center"}
...
![Chlorophyll a and pheophytin a average concentrations in the Central Delta.](/admin/figures-tables/phyto/phyto_wq_centraldelta.png){#fig-wq-centraldelta fig-align="center"}

#### Phytoplankton

`r strings_phyto_cur$summary_region_txt('Central Delta')` (Other, @fig-phy-centraldelta).

![Density of phytoplankton organisms in the Central Delta.](/admin/figures-tables/phyto/phyto_bar_centraldelta.png){#fig-phy-centraldelta fig-align="center"}
...
![Chlorophyll a and pheophytin a average concentrations in the Confluence.](/admin/figures-tables/phyto/phyto_wq_confluence.png){#fig-wq-confluence fig-align="center"}

#### Phytoplankton

`r strings_phyto_cur$summary_region_txt('Confluence')` (Other, @fig-phy-confluence).

![Density of phytoplankton organisms in the Confluence.](/admin/figures-tables/phyto/phyto_bar_confluence.png){#fig-phy-confluence fig-align="center"}
...
![Chlorophyll a and pheophytin a average concentrations in the North Delta.](/admin/figures-tables/phyto/phyto_wq_northdelta.png){#fig-wq-northdelta fig-align="center"}

#### Phytoplankton

`r strings_phyto_cur$summary_region_txt('North Delta')` (Other, @fig-phy-northdelta).

![Density of phytoplankton organisms in the North Delta.](/admin/figures-tables/phyto/phyto_bar_northdelta.png){#fig-phy-northdelta fig-align="center"}
...
![Chlorophyll a and pheophytin a average concentrations in the San Pablo Bay.](/admin/figures-tables/phyto/phyto_wq_sanpablobay.png){#fig-wq-sanpablobay fig-align="center"}

#### Phytoplankton

`r strings_phyto_cur$summary_region_txt('San Pablo Bay')` (Other, @fig-phy-sanpablobay).

![Density of phytoplankton organisms in the San Pablo Bay.](/admin/figures-tables/phyto/phyto_bar_sanpablobay.png){#fig-phy-sanpablobay fig-align="center"}
...
![Chlorophyll a and pheophytin a average concentrations in the South Delta.](/admin/figures-tables/phyto/phyto_wq_southdelta.png){#fig-wq-southdelta fig-align="center"}

#### Phytoplankton

`r strings_phyto_cur$summary_region_txt('South Delta')` (Other, @fig-phy-southdelta).

![Density of phytoplankton organisms in the South Delta.](/admin/figures-tables/phyto/phyto_bar_southdelta.png){#fig-phy-southdelta fig-align="center"}
...
![Chlorophyll a and pheophytin a average concentrations in Suisun and Grizzly Bays.](/admin/figures-tables/phyto/phyto_wq_suisunandgrizzlybays.png){#fig-wq-suisunandgrizzlybays fig-align="center"}

#### Phytoplankton

`r strings_phyto_cur$summary_region_txt('Suisun and Grizzly Bays')` (Other, @fig-phy-suisunandgrizzlybays).

![Density of phytoplankton organisms in Suisun and Grizzly Bays.](/admin/figures-tables/phyto/phyto_bar_suisunandgrizzlybays.png){#fig-phy-suisunandgrizzlybays fig-align="center"}
...
![Chlorophyll a and pheophytin a average concentrations in Suisun Marsh.](/admin/figures-tables/phyto/phyto_wq_suisunmarsh.png){#fig-wq-suisunmarsh fig-align="center"}

#### Phytoplankton

`r strings_phyto_cur$summary_region_txt('Suisun Marsh')` (Other, @fig-phy-suisunmarsh).

![Density of phytoplankton organisms in Suisun Marsh.](/admin/figures-tables/phyto/phyto_bar_suisunmarsh.png){#fig-phy-suisunmarsh fig-align="center"}

## Interpretations

Water year 2024 was above average in precipitation for both the Sacramento and San Joaquin Rivers and their watersheds. Chlorophyll a and pheophytin a values were low overall, with many samples being below the detection limit. Higher outflows that can occur during wet or above normal water years often reduce the residence time of the water, leading to less opportunities for large algal blooms. The phytoplankton community in all regions was dominated by small, but numerically abundant, cyanobacteria. Phytoplankton fell into 12 distinct categories, similar to previous years, with nearly all groups being found in all regions. However, the top ten taxa fell into just 5 categories, showing that while the overall community is diverse, phytoplankton tend to be numerically dominated by a small number of algal groups.
...
Previous EMP phytoplankton reports can be found [here](https://github.com/emp-dwr/emp-website/tree/main/admin/archive/phyto).