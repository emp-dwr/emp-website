...
knitr::include_graphics(file.path('html-css/figures/general/deltamap.jpg'))
```
...
```{r echo=FALSE, fig.cap='Table 1: Station groupings of the six regions'}
...
<!--chapter:end:Rmd-files/d-wq/dwq-data.Rmd-->
...
<!--chapter:end:Rmd-files/benthic/benthic-intro.Rmd-->
...
```{r echo=FALSE}
xfun::embed_file(path = 'data/benthic/benthic_site_locs.xlsx', name = 'benthic_site_locs.xslx', text = 'here.')
```
...
```{r echo=FALSE, out.width='80%', fig.align='center', fig.cap='Map of EMP\'s current benthic field sites.'}
...
```{r echo=FALSE, fig.show = 'hold', out.width = '50%', fig.cap='Density of benthic organisms, by month, collected at station (left) D41 and (right) D41A in 2019.', fig.align='center'}
...
```{r echo=FALSE, fig.show = 'hold', out.width = '50%', fig.cap='Density of benthic organisms, by month, collected at station (left) D6 and (right) D7 in 2019.', fig.align='center'}
...
```{r echo=FALSE, out.width = '50%', fig.cap='Density of benthic organisms, by month, collected at station D4 in 2019.', fig.align='center'}
...
```{r echo=FALSE, fig.show = 'hold', out.width = '50%', fig.cap='Density of benthic organisms, by month, collected at station (left) D24, (center) D16 and (right) D28A in 2019.', fig.align='center'}
knitr::include_graphics(file.path('figures/benthic/Fig2_D24.png'))
...
```{r echo=FALSE, fig.show = 'hold', out.width = '50%', fig.cap='Density of benthic organisms, by month, collected at station (left) P8 and (right) C9 in 2019.', fig.align='center'}
...
<!--chapter:end:Rmd-files/benthic/benthic-data.Rmd-->
...
<!--chapter:end:Rmd-files/general/refs.Rmd-->
