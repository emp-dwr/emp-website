...
<!-- This section writes out a formula. If the text needs to be modified, let Perry know. -->
...
<br> where $k$ is a flow meter collection value, and $a$ is the area of the mouth of the net (mm$^2$).
