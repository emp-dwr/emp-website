---
title: "Discrete Water Quality Monitoring Report for Water Year `r params$report_year`"
params:
  report_year: null
...
source(repo_path('admin', 'import_scripts.R'))
...
\includegraphics[width=0.6\textwidth]{`r repo_path('admin/figures-tables/admin/EMP_footer.png')`}
\end{center}
...
knitr::include_graphics(repo_path('admin/figures-tables/dwq/dwq_station_map_pdf.jpg'))
```
...
knitr::include_graphics(repo_path('admin/figures-tables/dwq/dwq_ts_spcndsurface.png'))
```
...
knitr::include_graphics(repo_path('admin/figures-tables/dwq/dwq_ts_turbiditysurface.png'))
```
...
knitr::include_graphics(repo_path('admin/figures-tables/dwq/dwq_ts_dissammonia.png'))
```
...
knitr::include_graphics(repo_path('admin/figures-tables/dwq/dwq_ts_chla.png'))
```
...
knitr::include_graphics(repo_path('admin/figures-tables/dwq/dwq_ts_dissnitratenitrite.png'))
```
...
knitr::include_graphics(repo_path('admin/figures-tables/dwq/dwq_ts_totphos.png'))
```
...
dwq_stations <- readr::read_csv(repo_path('admin/figures-tables/dwq/dwq_stations.csv'))
