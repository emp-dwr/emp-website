...
knitr::kable(cwq_stations, caption = 'Regions of Continuous EMP', row.names = FALSE)
```
...
knitr::kable(params, caption = 'Parameters sampled by Continuous EMP', row.names = FALSE)
```
...
knitr::kable(nid, caption = 'Rating criteria for continuous sonde calibration')
```
...
knitr::kable(cid, caption = 'Rating criteria for continuous sonde calibration')
```
...
knitr::kable(sid, caption = 'Rating criteria for continuous sonde calibration')
```
...
knitr::kable(conf, caption = 'Rating criteria for continuous sonde calibration')
```
...
knitr::kable(grizzly, caption = 'Rating criteria for continuous sonde calibration')
```
