...
organisms/mL=C/(VA_f F)
where C is the organism count, A_c is the area of the cell bottom (mm2), A_f is the area of each grid field (mm2), F is the number of fields examined, and V is the settled volume (mL). This simplifies to:
organisms/mL=C/cV

where cV=A_c/VA_f F and is equal to the counted volume.
...
knitr::include_graphics(file.path('sections/phyto/figures/fig2.png'))
```
...
knitr::include_graphics(file.path('sections/phyto/figures/fig3.png'))
```
...
knitr::include_graphics(file.path('sections/phyto/figures/fig4.png'))
```
...
knitr::include_graphics(file.path('sections/phyto/figures/fig5.png'))
```
...
knitr::include_graphics(file.path('sections/phyto/figures/fig6.png'))
```
...
knitr::include_graphics(file.path('sections/phyto/figures/fig7.png'))
```
...
knitr::include_graphics(file.path('sections/phyto/figures/fig8.png'))
```
...
knitr::include_graphics(file.path('sections/phyto/figures/fig9.png'))
```
...
knitr::include_graphics(file.path('sections/phyto/figures/fig10.png'))
```
...
knitr::include_graphics(file.path('sections/phyto/figures/fig11.png'))
```
...
knitr::include_graphics(file.path('sections/phyto/figures/fig12.png'))
```
...
knitr::include_graphics(file.path('sections/phyto/figures/fig13.png'))
```
...
knitr::include_graphics(file.path('sections/phyto/figures/fig14.png'))
```
