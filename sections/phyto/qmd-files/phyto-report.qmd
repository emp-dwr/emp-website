...
include_graphics(here::here(file.path('sections/phyto/figures/phyto_station_map.png')))
```
...
dwq_stations <- readr::read_csv(here::here('sections/phyto/tables/phyto_stations.csv'))
...
include_graphics(here::here(file.path('sections/phyto/figures/phyto_tree.png')))
```
...
include_graphics(here::here(file.path('sections/phyto/figures/phyto_wq_carquinez.jpg')))
```
...
include_graphics(here::here(file.path('sections/phyto/figures/phyto_bar_carquinez.jpg')))
```
...
include_graphics(here::here(file.path('sections/phyto/figures/phyto_wq_centraldelta.jpg')))
```
...
include_graphics(here::here(file.path('sections/phyto/figures/phyto_bar_centraldelta.jpg')))
```
...
include_graphics(here::here(file.path('sections/phyto/figures/phyto_wq_confluence.jpg')))
```
...
include_graphics(here::here(file.path('sections/phyto/figures/phyto_bar_confluence.jpg')))
```
...
include_graphics(here::here(file.path('sections/phyto/figures/phyto_wq_northdelta.jpg')))
```
...
include_graphics(here::here(file.path('sections/phyto/figures/phyto_bar_northdelta.jpg')))
```
...
include_graphics(here::here(file.path('sections/phyto/figures/phyto_wq_sanpablobay.jpg')))
```
...
include_graphics(here::here(file.path('sections/phyto/figures/phyto_bar_sanpablobay.jpg')))
```
...
include_graphics(here::here(file.path('sections/phyto/figures/phyto_wq_southdelta.jpg')))
```
...
include_graphics(here::here(file.path('sections/phyto/figures/phyto_bar_southdelta.jpg')))
```
...
include_graphics(here::here(file.path('sections/phyto/figures/phyto_wq_suisungrizzlybays.jpg')))
```

#### Phytoplankton

`r strings_phyto_cur$summary_region_txt('Suisun & Grizzly Bays')` (Other, @fig-phy-suisungrizzlybays).
...
include_graphics(here::here(file.path('sections/phyto/figures/phyto_bar_suisungrizzlybays.jpg')))
```
...
include_graphics(here::here(file.path('sections/phyto/figures/phyto_wq_suisunmarsh.jpg')))
```
...
include_graphics(here::here(file.path('sections/phyto/figures/phyto_bar_suisunmarsh.jpg')))
```
