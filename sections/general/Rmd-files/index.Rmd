...
# CA Dept of Water Resources - Environmental Monitoring Program {.unlisted .unnumbered}
```{r, echo=FALSE, customcap = capFig('Slideshow of DWR EMP locations.')}
# add in slideshow
htmltools::includeHTML('admin/html-css/slideshow.html')
```
...
```{r end-index, echo=FALSE, out.width = '400px', fig.align='center', customcap = capFig('Map of the Sacramento-San Joaquin Delta. Source: DWR')}
