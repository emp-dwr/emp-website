...
#| 
include_graphics(here::here(file.path('sections/cwq/figures/cwq_station_map.png')))
```
...
cwq_stations <- readr::read_csv(here::here('sections/cwq/tables/cwq_stations.csv'))
...
include_graphics(here::here(file.path('sections/cwq/figures/cwq_ts_watertemperature.jpg')))
```
...
include_graphics(here::here(file.path('sections/cwq/figures/cwq_ts_spc.jpg')))
```
...
include_graphics(here::here(file.path('sections/cwq/figures/cwq_ts_dissolvedoxygen.jpg')))
```
...
include_graphics(here::here(file.path('sections/cwq/figures/cwq_rri_do.jpg')))
```
...
include_graphics(here::here(file.path('sections/cwq/figures/cwq_ts_ph.jpg')))
```
...
include_graphics(here::here(file.path('sections/cwq/figures/cwq_ts_turbidity.jpg')))
```
...
include_graphics(here::here(file.path('sections/cwq/figures/cwq_ts_fluorescence.jpg')))
```
