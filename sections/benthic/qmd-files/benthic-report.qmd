...
#| 
knitr::include_graphics(here::here(file.path('sections/benthic/figures/benthic_station_map.png')))
```
...
knitr::include_graphics(here::here(file.path('sections/benthic/figures/benthic_bar_d6.jpg')))
```
